...
import { buildClinicAdminPatientDetailsPageRoute } from '@/constants/buildRoutes';
...
const ClinicDocuments = () => {
  ...
  const openPdfInNewTab = async (id: string, status: string) => {
    ...
    window.open(`${ClinicRoute.Documents}/${id}`, '_blank');
  };
    ...
    },
    {
      ...
      renderCell: row => (
        <TableLink
          ...
          href={buildClinicAdminPatientDetailsPageRoute(row.patientId)}
  ...
  return (
    <>
      ...
      <p className="mb-4 h-14 w-64 bg-gradient-to-r from-cryo-blue to-cryo-cyan bg-clip-text text-4xl font-light text-transparent">
        {t('title')}
      </p>
        ...
        <div className="mb-4 w-full md:mb-0">
          <div className="flex items-center justify-between gap-4 md:mr-4 md:max-w-[500px]">
            <TextInput
              ...
              type="text"
              placeholder="Search by patient, title"
