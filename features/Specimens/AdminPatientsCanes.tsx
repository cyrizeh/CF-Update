...
import { useGetAdminPatientsCanes, useGetCaneById } from '@/api/queries/speciment.queries';
...
import { consentList, LocationStatus, locationStatuses } from '@/constants/specimens';
...
export default AdminPatientsCanes;
