import { useGetSpecimens, useGetPatientsSpecimens } from '@/api/queries/speciment.queries';
...
const AdminPatientsSpecimens = ({ patientIdProps }: { patientIdProps?: string }) => {
...
export default AdminPatientsSpecimens;
